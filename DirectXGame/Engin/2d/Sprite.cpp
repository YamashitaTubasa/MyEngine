...
//void Sprite::StaticInitialize(ID3D12Device* device_)
//{
//	// NULLチェック
//	assert(device);
//
//	// デバイスの取得
//	Sprite::device = device_;
//}
